...
void
FrameBufferObject::Init(size_t W, size_t H, size_t colorBufferNum)
{
    ...
    for (size_t i = 0; i < fboColorBufferNum; ++i) {
        ...
        glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, fboWidth, fboHeight, 0, GL_RGBA, GL_UNSIGNED_BYTE, dummyData);
...
void
FrameBufferObject::BindMultiple(size_t colorBufferLeft, size_t colorBufferRight)
{
...
void
FrameBufferObject::BindSingle(size_t colorBufferIdx)
{
